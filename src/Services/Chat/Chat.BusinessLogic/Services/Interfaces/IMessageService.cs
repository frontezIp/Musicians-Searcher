...
namespace Chat.BusinessLogic.Services.Interfaces
{
    ...
    {
        Task<MessageResponseDto?> CreateMessageAsync(Guid messengerUserId, Guid chatRoomId, CreateMessageRequestDto createMessageRequestDto, CancellationToken cancellationToken = default);
